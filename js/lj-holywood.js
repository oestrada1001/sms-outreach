...
//    });
    ...
    $("#words").wordsrotator({
      ...
      words: ['<strong>Mass texting from a computer</strong> made easy!','<strong>Try before you buy with our free trial.</strong>','<strong>Bulk text messaging</strong> with statistics.']  //Array of words, it may contain HTML values
    });
