...
if(!isset($_SESSION['first_time_email'])){
    header("Location: ../index.php");
}

$email = $_SESSION['first_time_email'];
...
?>
    ...
    <div class="container">
        ...
        <div class="col-md-6">
            <h2>Instrustions:</h2>
            <p>We sent you an email to: <b><?php print_r($email); ?></b>. The email contains a special link to confirm your account. The link will take you to a page where you will be able to set your account's password. If you do not find the email, check your spam folder, if you still do not find the email contact us so we can help you finish setting up your account.</p>
        ...
        <div class="row">
            <div class="col-md-6">
                <h2>Thank you <b><?php print_r($first_name); ?></b>.</h2>
