...
$val = "SELECT * FROM admin WHERE email = '$email'";

$val = mysqli_query($db_connect, $val);
$val1 = mysqli_num_rows($val);
$val = mysqli_fetch_array($val, MYSQLI_ASSOC);
...
<body>
	...
	<div class="container-fluid">
       ...
       <a href="../employee/register.php" class="btn btn-primary">Register Client</a>
